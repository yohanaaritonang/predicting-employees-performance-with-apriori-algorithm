...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
| employee_id               |	 Nominal	          |    ID dari dari setiap karyawan (unik)                                                                      |
| department	              |  Nominal	          |    Nama departemen karyawan                                                                                 |
| region	                  |  Nominal	          |    Asal wilayah kerja                                                                                       |
| education	                |  Nominal	          |    Tingkat pendidikan                                                                                       |
| gender	                  |  Binary	            |    Jenis kelamin karyawan                                                                                   |
| recruitment_channel	      |  Nominal	          |    Kanal rekrutmen untuk karyawan                                                                           |
